...
export function phoneticSimilarity(word1, word2) {
  const soundex = (str) => {
...
export function analyzeReading(referenceText, transcript) {
...
// Calculate accuracy
export function calculateAccuracy(referenceText, transcript) {
...
export function getErrorTypeName(type) {
  const typeNames = {
    omission: 'Omission',
...
export function getErrorTypeDescription(type) {
  const descriptions = {
    omission: 'Word was skipped/not read',
    substitution: 'Different word was spoken',
    insertion: 'Extra word was added',
    mispronunciation: 'Word was pronounced incorrectly'
  };
